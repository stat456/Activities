...
### Q1.
In the context of the rolling a die, sketch a prior belief on the probabilities for the die resulting in a 6.
...
2. Define a descriptive model for the relevant data. Identify the statistical parameters in the analysis.

3. Specify (sketch and identify a distribution) a prior distribution for the parameters in the model.
