...
Write JAGS code to fit this model. Output the results. Hint for an inverse gamma model in JAGS, use the following..
...
Note in JAGS you can add the following lines to the model section of your code
