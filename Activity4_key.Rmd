...
This would be approximately (0, 7) (`ppois(7,4)`)
...
This would be approximately (0, 7) (`pnbinom(7,mu =4, size = 100)`)
...
This would be approximately (0, 10) (`pnbinom(10,mu =4, size = 100)`)
